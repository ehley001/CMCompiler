...
{
       0,    58,    58,    60,    62,    65,    66,    68,    72,    79,
      81,    84,    89,    90,    92,    95,    98,   102,   107,   112,
     114,   116,   119,   121,   122,   123,   124,   125,   127,   129,
     131,   135,   141,   146,   148,   152,   155,   157,   158,   162,
     167,   169,   170,   171,   172,   173,   174,   176,   181,   183,
     184,   186,   190,   192,   193,   195,   198,   199,   200,   202,
     206,   207,   209,   212
};
#endif
...
#line 61 "../CMinus.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-1]); (yyval)->child.push_back((yyvsp[0]));}
...
#line 69 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(40, string("vardecl"));
...
#line 73 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(41, string("arrayVar"));
...
#line 85 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-4]); (yyval) -> ruleNum=60; (yyval) ->text=((yyvsp[-5])->text);
        (yyval) -> child.push_back((yyvsp[-2]));
        (yyval) -> child.push_back((yyvsp[0]));}
...
#line 90 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(264, string("void"));}
...
#line 95 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(81, string("paramlist"));
        (yyval) -> child.push_back((yyvsp[0]));}
...
#line 99 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(90, string("param"));
        (yyval) -> child.push_back((yyvsp[-1]));
        (yyval) -> child.push_back((yyvsp[0]));}
...
#line 103 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(91, string("paramArray"));
...
#line 108 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(100, string("compoundstmt"));
        (yyval) -> child.push_back((yyvsp[-2]));
        (yyval) -> child.push_back((yyvsp[-1]));}
...
#line 114 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(111, string("localdeclarations"));}
...
#line 119 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(121, string("exp list"));}
...
#line 132 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(150, string("selectionstmt"));
        (yyval) -> child.push_back((yyvsp[-2]));
        (yyval) -> child.push_back((yyvsp[0]));}
...
#line 142 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(160, string("iterationstmt"));
        (yyval) -> child.push_back((yyvsp[-2]));
        (yyval) -> child.push_back((yyvsp[0]));}
...
#line 147 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(170, string("return"));}
#line 1532 "../parser.cpp" /* yacc.c:1646  */
    break;

  case 34:
#line 149 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(171, string("return with val"));
        (yyval) -> child.push_back((yyvsp[-1]));}
...
#line 153 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(180, string("assignment"));
        (yyval) -> child.push_back((yyvsp[-2])); (yyval) -> child.push_back((yyvsp[0]));}
...
#line 159 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(191, string("var"));
        (yyval) -> child.push_back((yyvsp[-1]));}
...
#line 183 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]);(yyval) = new treenode(220, string("+"));}
...
#line 192 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]);(yyval) = new treenode(240, string("*"));}
...
#line 196 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(260, string("factor"));
        (yyval) -> child.push_back((yyvsp[-1]));}
...
#line 198 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]); (yyval) -> ruleNum=261;}
...
#line 200 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]); (yyval) -> ruleNum=263;}
...
#line 210 "../CMinus.y" /* yacc.c:1646  */
    {
        (yyval) = (yyvsp[-2]); (yyval)->child.push_back((yyvsp[0]));}
#line 1720 "../parser.cpp" /* yacc.c:1646  */
    break;

  case 63:
#line 212 "../CMinus.y" /* yacc.c:1646  */
    {(yyval) = new treenode(291, string("arglist"));
        (yyval) -> child.push_back((yyvsp[0]));}
